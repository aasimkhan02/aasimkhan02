...
<div style="display: flex; align-items: flex-start; gap: 30px; margin-top: 20px; flex-direction: row">
  <div style="flex: 1;">
    <h2>💫 About Me</h2>
  ...
  <div style="flex-shrink: 0;">
    <img src="./Computer.jpg" width="420" style="border-radius: 12px;" alt="Computer Image">
  </div>
</div>
